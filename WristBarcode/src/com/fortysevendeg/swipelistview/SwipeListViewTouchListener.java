...
public class SwipeListViewTouchListener implements View.OnTouchListener {
    ...
    View.OnLongClickListener defaultOnLongClickListener;
    ...
    public SwipeListViewTouchListener(SwipeListView swipeListView, int swipeFrontView, int swipeBackView) {
        ...
        defaultOnLongClickListener = new View.OnLongClickListener() {
            @Override
    ...
    private void setFrontView(View frontView) {
        ...
        if (swipeOpenOnLongPress) {
            frontView.setOnLongClickListener(defaultOnLongClickListener);
        }
    }
    ...
    public void setOnLongClickListener(View.OnLongClickListener listener) {
    	defaultOnLongClickListener = listener;
    }
